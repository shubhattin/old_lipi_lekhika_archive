...
class Design:
    def __init__(self, main_obj, master):
        ...
        self.__root.iconbitmap(r'resources\Icon.ico')
    ...
    def option_frame(self) -> None:
        ...
        self.__option_window.iconbitmap(r'resources\Icon.ico')
    ...
    def __open_pdf(self):
        path = 'resources\\' + {1: 'उपयोगकर्ता पुस्तिका.pdf',
                             0: 'User Manual.pdf',
...
class Main():
    def __init__(self):
        ...
        self.__systray = SysTrayIcon(
            r'resources\Icon.ico', self.__taskbar_text(),
